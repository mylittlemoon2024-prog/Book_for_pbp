...
ABOUT_TEXT = (
    ...
    "на саморазвитие.\n"
    "Проект создан в рамках книжного клуба «ВМЕСТЕ» — это коллаборация "
    "Page by Page и My little moon.\n\n"
    "Хотите помочь сделать бота ещё лучше? Поделитесь своими идеями — мы "
